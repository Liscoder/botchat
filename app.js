...
const APP_TOKEN = 'EAARvWN4pab0BAFlpLXufgn4PplknS1beiqnjFhDj3OJ6wMZBvzhpgVFZAvD0ef8gGDUXmtqFSJdE5u13sAdEAcX3ZCwwqpdUOioLWJMyejeFRwVy0ZBdoqy5IrMrZAxZBmuZAlkZBxLckFHcckK0iPOHlbWfUZBuzEaRqM4V1AcZBEZAAZDZD'
...
function evaluarMensaje(senderID, messageText){
	...
	}else if(isContain(messageText,'athena')){
...
function elementTemplate(){
	return {
		...
		image_url: "http://imgur.com/a/bYbqO",
		buttons: [
